    ...
    <ul id="nav">
      ...
      <li><a href="">procedure</a>
        <ul>
          ...
          <li><a href="">add a procedure</a></li>
        </ul>
      </li>
      <li><a href="">product</a>
        <ul>
      ...
      <form method="post" action="">
        <fieldset>
          ...
          <div>
            ...
            <textarea name="desc" class="procDesc">enter a description of the procedure</textarea>
            
            <label for="type">type:</label>
            <select name="type" >
              <option>select procedure type</option>
              <?php foreach ($prtList as $prt):?>
                <option value="<?php echo $prt['id'];?>"><?php echo $prt['code'] . " - " . $prt['desc'];?></option>
              <?php endforeach;?>
            </select>
          ...
          <div>
            ...
            <input type="text" name="code" placeholder="enter procedure code" />
            <label for="price">price:</label>
            <input type="text" name="price" placeholder="enter procedure price" />
            <label>favorite:</label>
            <input type="checkbox" name="favo" value=1 />
            <label for="favo" id="check">is favorite</label>
          </div>
        </fieldset>
