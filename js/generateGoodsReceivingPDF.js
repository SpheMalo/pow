function generateGoodsReceivingPDF()
{
    ...
    heading.get(0).innerHTML = "<strong>Goods Receiving Note</strong>";
    heading.get(0).style.textAlign='center';
    currentDate.get(0).innerHTML = "<strong>Date: </strong>" + new Date().toLocaleString();
    supplier.get(0).innerHTML = "<strong>From Supplier: </strong>";
    order.get(0).innerHTML = "<strong>Order Status:</strong> Pending";
    ...
    newHeader.append(order);
    newHeader.append(supplier);
    newHeader.append($('#receive').html()); //table
...
// This can be changed to "pt" (points), "mm" (Default), "cm", "in"
    doc.fromHTML(
        ...
        function (dispose) {
            ...
            doc.save('Generate Goods Receiving Note.pdf');
        }, margins
    );
}
