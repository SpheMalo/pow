function generateStockLevelPDF()
{
    ...
    heading.get(0).innerHTML = "<strong>Weekly Stock Level Report</strong>";
    ...
    newHeader.append($('#stock').html()); //table
...
// This can be changed to "pt" (points), "mm" (Default), "cm", "in"
    doc.fromHTML(
        ...
        function (dispose) {
            ...
            doc.save('Weekly Stock Level Report.pdf');
        }, margins
    );
}
