...
<html>
  ...
  <body>
    <form method="post" action="">
      ...
      <input type="text" name="user" placeholder="username" pattern="[a-zA-Z0-9]{7}" required title="only alphanumeric characters allowed"/>
      <input type="password" name="pass" placeholder="password" pattern="[a-zA-Z0-9]{7,8}" required />
